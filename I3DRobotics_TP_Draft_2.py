...
class mainWindow(QMainWindow):
    def __init__(self, title="I3DRobotics"):
        ...
        btn_pointcloud.triggered.connect(self.printer)
    ...
    def updateIndividualDeviceList(self, name):
        ...
        self.deviceList.append(Devices(self, "name", "device"))
...
class Devices:
    def __init__(self, self_, name, device):
        ...
        btn_connect.triggered.connect(self.selectReferer)
